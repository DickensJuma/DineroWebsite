      ...
      <div className="pb-16 green lg:pb-0 lg:z-10 lg:relative rounded-md">
        ...
        <div className="mt-12 lg:m-0 lg:col-span-2 lg:pl-8 rounded-md">
            <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
              <blockquote>
                <div>
                 <h2 className="text-2xl font-extrabold text-white">​Make Purchases using your salary at any time of the month</h2>
          ...
          <div className="relative lg:-my-8">
            <div aria-hidden="true" className="absolute inset-x-0 top-0 h-1/2 purple lg:hidden" />
